...
const rows = [
  createData('2023年', '6月', "井宿", "栄", "ここにバイオリズムの分取が表示されます。"),
  createData('2023年', '7月', "鬼宿", "業", "ここにバイオリズムの分取が表示されます。"),
  createData('2023年', '8月', "柳宿", "親", "ここにバイオリズムの分取が表示されます。"),
  createData('2023年', '9月', "星宿", "友", "ここにバイオリズムの分取が表示されます。"),
  createData('2023年', '10月', "張宿", "懐", "ここにバイオリズムの分取が表示されます。"),
];
